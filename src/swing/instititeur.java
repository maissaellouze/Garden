 ...
 * @author Admin
 */
public class instititeur extends javax.swing.JFrame {
Connection conn=connexionBD.Conexion();
    ...
    public void Affichage() {
        Connection conn = connexionBD.Conexion();
        try {
            String requete = "select `id_inst`, `name_inst`,`num_inst`,`dtenaiss_inst`,`etat` from instituteur ";
    ...
    private void initComponents() {
        ...
        nom_pren2 = new javax.swing.JTextField();
        ...
        btnrefresh.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/interface.png"))); // NOI18N
        ...
        jLabel2.setText("Liste des instititeurs ");
        ...
        jPanel3.add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 30, 960, 80));

        jScrollPane2.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(51, 153, 255)), "Teachers list", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Trebuchet MS", 1, 14), new java.awt.Color(0, 0, 102))); // NOI18N
        ...
        jPanel3.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 150, 360, 170));
        ...
        jPanel3.add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 430, -1, -1));
        ...
        jPanel3.add(Panelaction, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 430, 410, -1));
        ...
        liste.add(jLabel23, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 180, -1, -1));

        jLabel24.setText("Course can teach");
        liste.add(jLabel24, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 210, -1, 20));
        ...
        liste.add(cours, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 210, 110, -1));
        ...
        liste.add(nom_pren2, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 60, 110, -1));

        jPanel3.add(liste, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 140, 250, 250));
        ...
        jPanel3.add(jPanel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(730, 150, 230, 230));

        getContentPane().add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 50, 990, 540));
    ...
    private void TableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TableMouseClicked
        ...
        String sql="select * from instituteur where id_inst='"+id+"'";
        String sql2="select nom_mat from cours where code_mat=(select code_mat from instituteur where id_inst='"+id+"')";
    ...
    try {
        ...
        if (result.next())
        {
             cin.setText(result.getString(2));
            nom_pren2.setText(result.getString("name_inst"));
            ...
            dtenaiss.setText(result.getString("dtenaiss_inst"));
             ...
             result2.next();
            cours.setText(result2.getString("nom_mat"));
    ...
    //JOptionPane.showMessageDialog(null,"vous etes sur de supprimer un instititeur ");
    //Custom button text


  
 int res = JOptionPane.showConfirmDialog(null,"Etes-vous sur de supprimer un instituteur ?");
 if(res == JOptionPane.YES_OPTION)
    {
      btnsupprimer.setBackground(new java.awt.Color(255,255,255));
        ...
        String sql="DELETE FROM instituteur WHERE id_inst="+id;
    ...
    private void printbtnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_printbtnMouseClicked
        // TODO add your handling code here:
        String entete="liste des instituteur";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(instititeur.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new instititeur().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField nom_pren2;
